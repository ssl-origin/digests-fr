...
$lang = array_merge($lang, array(
	...
	'DIGESTS_DISCLAIMER'				=> 'Ce résumé est envoyé aux membres enregistrés des forums de <a href="%1$s">%2$s</a>. Vous pouvez modifier ou supprimer votre abonnement aux forums depuis le <a href="%1$sucp.%2$s">Panneau de contrôle de l\'utilisateur</a>. Si vous avez des questions ou si vous souhaitez réagir veuillez le faire en vous adressant au <a href="mailto:%1$s?subject=Digests">webmaster des forums de %2$s</a>.',
	...
	'DIGESTS_INTRODUCTION' 				=> 'Voici le résumé des derniers posts publiés sur les forums de %s. Pour répondre à un fil de discusson ou à un post veuillez vous connecter au forum en cliquant sur le lien en regard du libellé "Sujet" ou "Répondre". Vous serez dirigés vers le portail du forum afin de vous identifier, puis vous serez placés dans la rubrique du sujet choisi. Ne répondez pas à ce courriel, car la réponse n\'aboutira pas sur le forum !',
	...
	'DIGESTS_PUBLISH_DATE'				=> 'Ce résumé a tout particulièrement été généré pour %1$s le %2$s',
	...
	'DIGESTS_REMOVE_YOURS'				=> 'Retirer mes posts du résumé',
