...
Si vous avez des questions ou si vous souhaitez nous contacter veuillez adresser votre courriel au webmaster des forums : %4$s.',
	...
	'DIGESTS_INSTALL_REQUIREMENTS'		=> 'Votre version de phpBB doit être &gt ; 3.3.0 et &lt ; 4.0 pour installer cette extension. Veuillez résoudre ce problème, puis réessayer d&apos;activer l&apos;extension.',
	...
	'DIGESTS_LASTVISIT_RESET_EXPLAIN'	=> 'Lorsque l‘option est activée, la date et l&apos;heure de création de votre résumé sera utilisée pour définir votre date de dernière visite. Les notifications relatives aux sujets à l‘heure à laquelle le résumé a été créé seront également marquées comme lus.',
	'DIGESTS_LINK'						=> 'Lien du post',
        'DIGESTS_MAILED_TOOLTIP'			=> 'Cliquez pour voir les détails du courrier',	
	...
	'DIGESTS_NO_DETAILS_ERROR'			=> 'La base de données peut être incohérente. Aucun enregistrement de détail du résumé ne peut être trouvé pour cette date et cette heure.',
	...
	'DIGESTS_SKIPPED_TOOLTIP'			=> 'Cliquez pour voir les détails ignorés',
