...
Si vous avez des questions ou si vous souhaitez nous contacter veuillez adresser votre courriel au webmaster des forums : %4$s.',
	...
	'DIGESTS_NEW_POSTS_ONLY_EXPLAIN'	=> 'Cette option filtre tous les messages qui ont été messageés avant la date et l’heure de votre dernière visite sur ce forum. Si vous visitez le forum fréquemment et que vous lisez la plupart des messages, cela évitera l’affichage de messages redondants dans votre résumé. Vous risquez cependant de manquer certains messages dans des forums que vous n’avez pas lu.',
	...
	'DIGESTS_NO_POST_TEXT'				=> 'N’afficher aucun texte de messages',
	...
	'DIGESTS_SEND_ON_NO_POSTS'	 		=> 'Envoyer un résumé s’il n’y a pas de nouveaux messages',
	...
	'DIGESTS_TAG_REPLACED'				=> '<strong>Note : le contenu a été supprimé pour des raisons de sécurité. Cliquez sur le lien du message ou du sujet pour visualiser l’intégralité du contenu du message.</strong>',
