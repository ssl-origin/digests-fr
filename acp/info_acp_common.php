...
$lang = array_merge($lang, array(
	...
	'ACP_DIGESTS_BALANCE_LOAD_EXPLAIN'						=> 'Si le nombre de résumés envoyés est trop important à certaines heures de la journée, des problèmes de performance risquent de survenir. Cette page permet d\'équilibrer les abonnements au résumé de manière à ce qu\'environ le même nombre de résumés soit envoyé toutes les heures. La table ci-dessous affiche le nombre d\'abonnements actuels pour chacune des heures, l\'heure affichée étant basée sur le fuseau horaire défini dans votre panneau d\'utilisateur. Cette fonction met à jour a minima les heures d\'envoi des résumés. Les modifications ne surviennent qu\'aux heures pour lesquelles le nombre d\'abonnés excède la charge moyenne et ne s\'appliquent qu\'aux abonnés de la tranche horaire correspondante. <em>Attention</em>: les abonnés risquent de ne pas apprécier que l\'heure de leur abonnenment soit modifiée.',
