...
$lang = array_merge($lang, array(
	...
	'LOG_CONFIG_DIGESTS_NO_BOOKMARKS'						=> '<strong>Attention : l&apos;abonné %s souhaite des sujets cochés dans son résumé, mais il n&apos;a aucun sujet coché.</strong>',
        'LOG_CONFIG_DIGESTS_NO_RESOURCES'						=> '<strong>La fin des résumés de courrier de manière anormale. Les ressources système sont insuffisantes pour continuer à exécuter des résumés. Une erreur s‘est produite lors de la création d‘un résumé pour “%1$s” pour l‘heure %2$d UTC. Vous devrez peut-être mettre à niveau votre hébergement pour envoyer de manière fiable tous les résumés.</strong>',	
