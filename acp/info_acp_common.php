...
$lang = array_merge($lang, array(
	...
	'ACP_DIGESTS_BALANCE_LOAD_EXPLAIN'						=> 'Si trop de résumés envoyés à certaines heures entraînent des problèmes de performance, cette option rééquilibrera les abonnements aux résumés de manière à ce qu’à peu près le même nombre de résumés soit envoyé pour chacune des heures souhaitées. Le tableau ci-dessous affiche le nombre actuel et les noms des abonnés aux résumés pour chaque heure avec les <strong>heures sur-allouées</strong> en gras. Cette fonction met à jour les heures d&apos;envoi des résumés de manière minimale. Les modifications ne se s&apos;appliquent qu&apos;aux heures où le nombre d&apos;abonnés dépasse la charge moyenne, et seulement pour les abonnés qui dépassent la moyenne horaire pour cette heure. <em>Attention</em> : certains abonnés pourraient être contrariés par le fait que leurs heures d&apos;abonnement ont été modifiées et pourraient recevoir une notification par courriel, selon le paramètre défini dans les paramètres généraux des résumés. Si vous le souhaitez, vous pouvez limiter l&apos;équilibrage à un type de résumé, équilibrer pour des heures spécifiques et appliquer l&apos;équilibrage à des heures spécifiques.',
	...
	'ACP_DIGESTS_GENERAL_SETTINGS_EXPLAIN'					=> 'Cette rubrique présente les réglages généraux de Digests, un service permettant de générer un résumé des posts publiés sur vos forums. Veuillez noter que si les résumés doivent être délivrés rigoureusement en temps et en heure, vous devez paramétrer et activer le <a href="https://www.phpbb.com/customise/db/extension/digests_extension/faq/2716">service cron</a> de phpBB. Sinon dès qu&apos;il y aura trop de trafic sur le forum, les résumés de l&apos;heure courante et des heures passées seront envoyés. Pour plus d&apos;informations, veuillez lire les <a href="https://www.phpbb.com/customise/db/extension/digests_extension/faq">FAQs de l&apos;extension Digests.',
	...
	'ACP_DIGESTS_REPORTS_EXPLAIN'							=> 'Cette page permet de voir les résumés des résumés qui ont été envoyés à diverses dates et heures, ainsi que des informations sur les performances. Cliquez sur l&apos;en-tête d&apos;une colonne pour modifier la façon dont elle est triée. Cliquez sur l&apos;envoi ou la valeur ignorée d&apos;une ligne pour obtenir des détails sur l’instant où les actions d&apos;envoi ou d&apos;exclusion ont eu lieu pour les abonnés de l&apos;heure en question.',
	...
	'LOG_CONFIG_DIGESTS_LOG_ENTRY_GOOD'						=> array(
																1 => '<strong>Un %1$s résumé a été %2$s %3$s (%4$s) le %5$s à %6$02d h UTC contenant %7$d post et %8$d message privé.</strong>',
																2 => '<strong>Un %1$s résumé a été %2$s %3$s (%4$s) le %5$s à %6$02d h UTC contenant %7$d posts et %8$d messages privés.</strong>',
	),
	...
	'LOG_CONFIG_DIGESTS_LOG_ENTRY_GOOD_NO_EMAIL'			=> array(
																1 => '<strong>Un %1$s résumé a été %2$s %3$s (%4$s) le %5$s à %6$02d h UTC contenant %7$d post et %8$d message privé.</strong>',
																2 => '<strong>Un %1$s résumé a été %2$s %3$s le %4$s à %5$02d h UTC contenant %6$d messages et %7$d messages privés.</strong>',
															),
