...
$lang = array_merge($lang, array(
	...
	'ACP_DIGESTS_BALANCE_LOAD_EXPLAIN'						=> 'Si un trop grand nombre de résumés envoyés à certaines heures provoquent des problèmes de performance, cette page rééquilibrera les abonnements aux résumés afin qu’environ le même nombre de résumés soient envoyés à chaque heure souhaitée. Le tableau ci-dessous montre le nombre actuel et le nom des abonnés aux résumés pour chaque heure avec, signalées en gras, les <strong>heures en surcharge</strong>. Cette fonction met à jour le moins possible d’heures d’envoi des résumés : les modifications ne concernent que les heures où le nombre d’abonnés dépasse la charge moyenne, et seulement pour ceux qui dépassent la moyenne horaire pour cette heure. <em>Attention</em> : certains abonnés pourraient être contrariés par le fait que leurs heures d’abonnement ont été modifiées et pourraient recevoir une notification par courriel, selon les paramètres généraux des résumés. Si vous le souhaitez, vous pouvez limiter l’équilibrage à un type de résumé, équilibrer pour des heures spécifiques et appliquer l’équilibrage aux heures définies.',
	'ACP_DIGESTS_BALANCE_OPTIONS'							=> 'Options d’équilibrage',
	'ACP_DIGESTS_CLEAR_CACHED_DIGESTS'						=> 'Effacer les statistiques des rapports d’envoi et le cache des résumés',
	'ACP_DIGESTS_CLEAR_CACHED_DIGESTS_EXPLAIN'				=> 'Depuis cette page, vous pouvez purger tous les résumés mis en cache dans le répertoire /store/phpbbservices/digests. Ces fichiers peuvent être envoyés par le générateur de courriels manuel, mais représentent une vulnérabilité potentielle de sécurité. S’ils sont exposés, il est recommandé de les purger.<br><br>%1$d fichiers au total sont présents dans le cache.<br>Noms des fichiers : %2$s.<br><br>Vous pouvez également effacer les statistiques des rapports d’envoi de résumés générés par Digests.',
	'ACP_DIGESTS_GENERAL_SETTINGS'							=> 'Paramètres généraux',
	'ACP_DIGESTS_GENERAL_SETTINGS_EXPLAIN'					=> 'Cette page présente les paramètres généraux de l’extension Digests, qui permet de générer un résumé des messages publiés sur le forum. Veuillez noter que si le moment de l’envoi des résumés doit être garanti, vous devez configurer et activer les tâches récurrentes, en utilisant le <a href="https://www.phpbb.com/customise/db/extension/digests_extension/faq/2716">Cron système</a> de phpBB. Sinon, les résumés de l’heure courante et des heures passées seront envoyés dès qu’il y aura de l’activité sur le forum. Pour plus d’informations, voir la <a href="https://www.phpbb.com/customise/db/extension/digests_extension/faq">FAQ de l’extension Digests.</a>',
	...
	'ACP_DIGESTS_REPORTS_EXPLAIN'							=> 'Cette page permet de consulter les informations relatives aux résumés envoyés à divers moments, ainsi que sur les performances du serveur. Cliquez sur l’en-tête d’une colonne pour la trier. Cliquez sur le nombre de résumés envoyés ou ignorés d’une ligne pour obtenir des détails sur l’instant où les résumés ont été envoyés ou ignorés pour les abonnés concernés par l’horaire.',
	...
	'ACP_DIGESTS_TEST_EXPLAIN'								=> 'Cette fonction permet de déclencher manuellement l’envoi d’un résumé aux fins de test ou de dépannage. Vous pouvez également l’utiliser afin de renvoyer des résumés pour des heures où ils auraient pu ne pas être expédiés. Seule une heure de résumé est traitée et aucune donnée d’utilisateur n’est modifiée.<br><br> <strong>Abonnés pouvant recevoir les résumés pour l’heure courante :</strong> %s',
	...
	'LOG_CONFIG_DIGESTS_BALANCE_LOAD'						=> '<strong>L’équilibrage de charge d’envoi des résumés aux abonnés a été exécuté</strong>',
	...
	'LOG_CONFIG_DIGESTS_CLEAR_SPOOL_ERROR'					=> '<strong>Impossible de purger les fichiers dans le répertoire store/phpbbservices/digests. Cela peut être dû à des permissions insuffisantes ou à un chemin d’accès incorrect. Le répertoire doit être accessible en écriture (777 sur les systèmes de type Unix).</strong>',
	'LOG_CONFIG_DIGESTS_CREATE_DIRECTORY_ERROR'				=> '<strong>Impossible de créer le répertoire %s. Cela peut être dû à des permissions insuffisantes. Le répertoire doit être accessible en écriture (777 sur les systèmes de type Unix).</strong>',
	...
	'LOG_CONFIG_DIGESTS_FILE_OPEN_ERROR'					=> '<strong>Impossible d’ouvrir un fichier du répertoire %s. Cela peut être dû à des permissions insuffisantes. Le répertoire doit être accessible en écriture (777 sur les systèmes de type Unix).</strong>',
	'LOG_CONFIG_DIGESTS_FILE_WRITE_ERROR'					=> '<strong>Impossible d’écrire dans le fichier %s. Cela peut être dû à des permissions insuffisantes. Le répertoire doit être accessible en écriture (777 sur les systèmes de type Unix).</strong>',
	...
	'LOG_CONFIG_DIGESTS_INCONSISTENT_DATES'					=> '<strong>Une erreur inhabituelle est survenue. Aucun horaire n’a été traité car la dernière heure à laquelle les résumés ont été correctement envoyés (à %1$d) est postérieure à la préparation des résumés (à %2$d).</strong>',
	...
	'LOG_CONFIG_DIGESTS_LOG_ENTRY_GOOD_DISK'				=> '<strong>Un résumé a été enregistré dans le répertoire store/phpbbservices/digests/%s. Ce résumé n’a PAS été envoyé par courriel, mais a été placé ici aux fins d’analyse.</strong>',
	...
	'LOG_CONFIG_DIGESTS_NO_ALLOWED_FORUMS'					=> '<strong>Attention : l’abonné %s n’a aucune permission sur le forum. À moins qu’il n’y ait des forums requis, les résumés seront toujours vides.</strong>',
	...
	'LOG_CONFIG_DIGESTS_NO_RESOURCES'						=> '<strong>Arrêt anormal du générateur d’envoi des résumés. Les ressources du système sont insuffisantes pour continuer à traiter les résumés. Une erreur a été générée lors de la création d’un résumé pour « %1$s » à %2$d UTC. Vous devriez peut-être mettre à niveau votre hébergement pour fiabiliser l’envoi de tous les résumés.</strong>',
	...
	'LOG_CONFIG_DIGESTS_NOTIFICATION_SENT'					=> '<strong>Un courriel a été envoyé à %1$s (%2$s) pour signaler que les paramètres de ses résumés ont été modifiés.</strong>',
	...
	'LOG_CONFIG_DIGESTS_RESET_CRON_RUN_TIME'				=> '<strong>L’heure d’exécution de la tâche planifiée d’envoi des résumés a été réinitialisée</strong>',
	...
	'LOG_CONFIG_DIGESTS_SIMULATION_DATE_TIME'				=> '<strong>L’administrateur a demandé la création des résumés le %s, heure du forum.</strong>',
	...
	'LOG_CONFIG_DIGESTS_TIMEZONE_ERROR'						=> '<strong>Le user_timezone « %1$s » pour le nom d’utilisateur « %2$s » est invalide. Le fuseau horaire « %3$s » a été supposé. Veuillez demander à l’utilisateur de définir un fuseau horaire correct dans le panneau de contrôle de l’utilisateur. Voir https://php.net/manual/en/timezones.php pour une liste des fuseaux horaires valides.</strong>',
