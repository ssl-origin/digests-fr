...
$lang = array_merge($lang, array(
	...
	'ACP_DIGESTS_CLEAR_CACHED_DIGESTS'						=> 'Effacer les résumés en cache',
	'ACP_DIGESTS_CLEAR_CACHED_DIGESTS_EXPLAIN'				=> 'Cette page vous permet de supprimer tous les résumés mis en cache dans le répertoire /store/phpbbservices/digests. Ceux-ci peuvent être générés par le générateur de courriels manuel mais représentent une vulnérabilité potentielle en matière de sécurité.<br><br>Au total %1$d fichiers sont en cache. Si des fichiers sont affichés, il est recommandé de les supprimer. Nom de fichiers : %2$s',
