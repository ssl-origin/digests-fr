...
$lang = array_merge($lang, array(
	...
	'LOG_CONFIG_DIGESTS_CACHE_CLEARED'						=> '<strong>Le dossier store/phpbbservices/digests a été vidé',
	'LOG_CONFIG_DIGESTS_CLEAR_SPOOL_ERROR'					=> '<strong>Impossible d&apos;effacer les fichiers dans le dossier store/phpbbservices/digests. Cela peut être dû à un problème de permissions ou à un chemin d&apos;accès incorrect. Les permissions de fichier du dossier doivent être réglées sur écriture publique (777 sur les systèmes Unix).</strong>',
