...
$lang = array_merge($lang, array(
	...
	'DIGESTS_BALANCE_APPLY_HOURS'							=> 'Application de l‘équilibrage aux heures suivantes',
	...
	'DIGESTS_CUSTOM_STYLESHEET_PATH'						=> 'Chemin d‘accès à la feuille de style personnalisé',
	...
	'DIGESTS_ENABLE_LOG'									=> 'Inscrire toutes les actions du curriculum vitae dans le journal de l‘administrateur',
	...
	'DIGESTS_FROM_EMAIL_ADDRESS_EXPLAIN'					=> 'Lorsque les utilisateurs reçoivent un CV, cette adresse électronique va s‘afficher dans le champ "De". S‘il est laissé vide, l‘adresse électronique de votre Forum sera utilisée par défaut. Faites attention lorsque vous utilisez une adresse électronique dont le domaine ne correspond pas à celui sur lequel est hébergé votre Forum, dans la mesure où votre serveur de courriels ou le serveur de courriels des utilisateurs pourra interpréter le courriel comme étant du spam.',
	...
	'DIGESTS_SEARCH_FOR_MEMBER_EXPLAIN'						=> 'Entrez le nom complet ou partiel du membre ou l‘adresse e-mail à rechercher, puis appuyez sur retour. Laissez vide pour désactiver ce type de recherche. Les recherches de noms de membres ne sont pas sensibles à la casse. <em>Note</em> : Il doit y avoir un symbole @ dans le champ pour qu‘une recherche par e-mail soit effectuée..',
