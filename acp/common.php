...
$lang = array_merge($lang, array(
	...
	'DIGESTS_RUN_TEST_SEND_TO_ADMIN_EXPLAIN'				=> 'Si vous souhaitez envoyer par e-mail les résumés du test, tous les résumés seront envoyés par e-mail à l‘adresse indiquée dans le champ ci-dessous. <em>Remarque</em> : si vous avez choisi d‘envoyer des e-mails vers des fichiers, ce paramètre est ignoré. Si oui, mais qu‘aucune adresse e-mail n‘est spécifiée, l‘adresse e-mail de contact du forum sera utilisée. <em>Attention</em> : certains serveurs de messagerie peuvent interpréter un volume important d‘e-mails en peu de temps à partir de la même adresse comme du spam ou une utilisation inappropriée. Activer avec précaution. Si vous dites non, les résumés seront en fait envoyés aux abonnés, ce qui peut les embrouiller.',
